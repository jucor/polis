...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(
            f"{VIZ_CONFIG['output_base_dir']}/consensus_divisive_datamapplot.log",
            mode="a",
        ),
    ],
)
...
def load_data_from_dynamodb(zid, layer_num=0):
    ...
    # Results dictionary
    data = {"positions": {}, "clusters": {}, "topic_names": {}}
...
def load_comment_texts_and_extremity(zid, layer_num=0):
                    ...
                    if isinstance(data_obj, dict):
                        ...
                        if "ptptstats" in data_obj:
                            ...
                            if (
                                ...
                                logger.info(
                                    f"Extracted extremity values for {len(extremity_values)} comments from standard structure"
                                )
                            else:
    ...
    try:
        ...
        if math_main and math_main[0]:
            ...
            if (
                isinstance(math_data, dict)
                and "pca" in math_data
                and "comment-extremity" in math_data["pca"]
                and "tids" in math_data
            ):
                ...
                if (
                    isinstance(comment_extremity, list)
                    ...
                    if valid_extremity_values:
                        ...
                        print("Statistical metrics:", file=sys.stderr)
                        print(
...
def create_consensus_divisive_datamapplot(zid, layer_num=0, output_dir=None):
    ...
    try:
        ...
        # Add a title
        ax.set_title("Comments Colored by Consensus/Divisiveness", fontsize=16)
        ...
        ax.set_title("Comment Consensus/Divisiveness Map", fontsize=16)
        ax.text(
            0.5,
            0.05,
            "Green = Consensus Comments    Yellow = Mixed Opinions    Red = Divisive Comments",
