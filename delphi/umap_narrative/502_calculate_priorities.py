...
class PriorityCalculator:
    ...
    def calculate_comment_updates(
        ...
        for item in comment_data:
            try:
                ...
                updates.append(
                    {
                        "Key": {"zid_tick": zid_tick, "comment_id": comment_id},
    ...
    def run(self) -> bool:
        ...
        try:
            ...
            if success:
                logger.info(
                    f"Priority calculation and update completed successfully for {len(updates_to_perform)} comments in {elapsed:.2f}s"
                )
